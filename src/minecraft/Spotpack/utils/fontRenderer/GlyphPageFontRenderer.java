...
public class GlyphPageFontRenderer {
   ...
   private void doDraw(float f, GlyphPage glyphPage) {
      ...
      if (this.strikethroughStyle) {
         ...
         worldrenderer1.pos((double)this.posX, (double)(this.posY + (float)(glyphPage.getMaxFontHeight() / 2)), 0.0D).endVertex();
         worldrenderer1.pos((double)(this.posX + f), (double)(this.posY + (float)(glyphPage.getMaxFontHeight() / 2)), 0.0D).endVertex();
         worldrenderer1.pos((double)(this.posX + f), (double)(this.posY + (float)(glyphPage.getMaxFontHeight() / 2) - 1.0F), 0.0D).endVertex();
         worldrenderer1.pos((double)this.posX, (double)(this.posY + (float)(glyphPage.getMaxFontHeight() / 2) - 1.0F), 0.0D).endVertex();
         tessellator1.draw();
         GlStateManager.enableTexture2D();
      }
   ...
   public void drawCenteredString(String text, float x, float y, int color) {
      this.drawString(text, x - (float)(this.getStringWidth(text, y) / 2), y, color, this.boldStyle);
   }
}
